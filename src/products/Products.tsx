  ...
  return (
    <Layout>
        <div className="flex items-center justify-between my-[1rem]">
          <h1 className="lg:text-[2rem] text-[1.8rem] font-semibold">All Products</h1>
          <Dialog open={openProductDialog} onOpenChange={setOpenProductDialog}>
            <DialogTrigger className="yena-btn" onClick={() => {setOpenProductDialog(true); editProduct(null, false)}}>
               Create New
          </DialogTrigger>
