  ...
  const formAction = async (formData: any) => {
    ...
    if (adminInfo) {
      const product = {
        ...
        price: editingMode ? Number(price) : formData.get("price"),
        sizes: size.split(","),
        images: previewImage,
        inStock,
      };
      ...
      <DialogHeader>
        ...
        <form action={formAction} className="space-y-6">
          ...
          <div className="col-span-full">
            <label
              htmlFor="cover-photo"
              className="block text-sm/6 font-medium dark:text-gray-300 text-gray-900"
            >
              Cover photo
            </label>
          ...
          <div>
            <button
              type="submit"
              className="yena-btn w-full dark:yena-btn-dark"
            >
              {editingMode
                ? isLoading
                  ? "Saving..."
