  ...
  return (
      ...
      <p className="lg:mt-4 mt-2 text-muted-foreground">
        ...
        <div className="lg:grid flex flex-col grid-cols-4 gap-[1rem] mt-[2rem]">
            ...
            <div className="shadow-md p-[1rem] rounded-[1rem] border">
            <div className="flex items-center justify-between"><span className="text-[1rem] text-muted-foreground">Total Orders</span> <ShoppingCartIcon className="text-muted-foreground w-[1.2rem] h-[1.2rem]"/></div>
                  ...
                  orders.map((order) => (
                    ...
                    <div className="flex items-center gap-[1rem]">
                      <img src={order.userId.avatar} alt={order.userId.name} className="w-[2rem] h-[2rem] rounded-full"/>
                       ...
                       <div>
                           <h1 className="font-semibold lg:text-[1rem] text-[.9rem]">{order.userId.name}</h1>
                           <span className="lg:text-[1rem] text-[.9rem]">{order.userId.email}</span>
                       </div>
                    </div>
  
                    <div>
                         <span className="text-green-500 lg:text-[1rem] text-[.9rem]">+{formatCurrency(order.totalAmount)}</span>
                    </div>
                   </div>
                  ))
                 ) : (
